...
Source:
[`inst/CITATION`](https://github.com/HugoMachadoRodrigues/soilKey/blob/v0.9.94-data/inst/CITATION)

Rodrigues, H. (2026). soilKey: Automated soil profile classification per
WRB 2022, SiBCS 5, and USDA Soil Taxonomy 13. R package version 0.9.94.
