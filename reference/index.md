...
- [`.munsell_hue_units()`](https://hugomachadorodrigues.github.io/soilKey/reference/dot-munsell_hue_units.md)
...
- [`.wrb_acidity_fracs()`](https://hugomachadorodrigues.github.io/soilKey/reference/dot-wrb_acidity_fracs.md)
...
- [`humic_colour_usda()`](https://hugomachadorodrigues.github.io/soilKey/reference/humic_colour_usda.md)
  : Humic colour-value intergrade (KST 13ed) — Hum\* Inceptisol
  subgroups
...
- [`qual_activic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_activic.md)
  :

  Activic supplementary qualifier (av): active aluminium \>= 5 cmol/kg
  WRB 2022 Ch 5: "KCl-extractable Al (`al_kcl_cmol`) \>= 5 cmol(c)/kg in
...
- [`qual_alcalic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_alcalic.md)
  : Alcalic supplementary qualifier (ac): pH (H2O) \>= 9.0 WRB 2022 Ch
  5: "Strongly alkaline reaction (pH H2O \>= 9 in any layer within 100
...
- [`qual_anofluvic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_anofluvic.md)
...
- [`qual_anthromollic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_anthromollic.md)
  : Anthromollic qualifier (am): anthric horizon overlying spodic

- [`qual_archaic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_archaic.md)
...
- [`qual_arenicolic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_arenicolic.md)
...
- [`qual_bathyspodic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_bathyspodic.md)
  : Bathyspodic supplementary qualifier (bs): spodic at 100-200 cm depth

- [`qual_biocrustic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_biocrustic.md)
...
- [`qual_bryic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_bryic.md)
...
- [`qual_capillaric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_capillaric.md)
  : Capillaric supplementary qualifier (cp): capillary rise zone WRB
  2022 Ch 5: "Capillary rise from a shallow water table to within 50 cm
  of the soil surface; flagged via redox concentrations (\>=2%) + fine
  texture (clay+silt \> 50%)."
...
- [`qual_carbonatic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_carbonatic.md)
  : Carbonatic supplementary qualifier (cn): \>= 50% carbonates

- [`qual_carbonic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_carbonic.md)
...
- [`qual_chloridic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_chloridic.md)
  :

  Chloridic supplementary qualifier (cl): high chloride WRB 2022 Ch 5:
  "Containing \>= 4 cmol(c)/kg chloride OR EC \>= 8 dS/m within 100 cm."
  Proxy via electrical conductivity field (`ec_ds_m`) when chloride is
  unavailable.
...
- [`qual_claric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_claric.md)
...
- [`qual_cohesic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_cohesic.md)
  :

  Cohesic supplementary qualifier (co): cohesive horizon (extra-firm
  dry) WRB 2022 Ch 5: "Containing layers with extreme dry consistence
  AND moist consistence very firm." Implementation: matches via
  `consistence_dry` ("extremely hard") OR `consistence_moist` ("very
  firm"), within 100 cm.

- [`qual_columnic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_columnic.md)
  : Columnic supplementary qualifier (cm): columnar / prismatic
  structure WRB 2022 Ch 5: "Columnar or strong prismatic structure
  (associated with natric horizons)."

- [`qual_cordic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_cordic.md)
...
- [`qual_differentic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_differentic.md)
  : Differentic supplementary qualifier (df): contrasting layers WRB
  2022 Ch 5: "Strong differences (texture, mineralogy, color) between
  adjacent layers without abrupt textural transition (mild clay-increase
  1.2-1.4x ratio)."
...
- [`qual_dorsic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_dorsic.md)
...
- [`qual_endic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endic.md)
  : Endic supplementary qualifier (ec): generic "in deep horizon" marker

- [`qual_endoabruptic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endoabruptic.md)
  : Endoabruptic supplementary qualifier (eea): abrupt textural change
  deep

- [`qual_endocalcaric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endocalcaric.md)
...
- [`qual_endodolomitic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endodolomitic.md)
  : Endodolomitic qualifier (dme): dolomitic only at depth \>= 50 cm

- [`qual_endoduric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endoduric.md)
  : Endoduric supplementary qualifier: duric horizon at depth \>= 50 cm

- [`qual_endodystric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endodystric.md)
  : Endodystric supplementary qualifier (eds): dystric only at depth

- [`qual_endoeutric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endoeutric.md)
...
- [`qual_endogypsic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endogypsic.md)
  : Endogypsic supplementary qualifier: gypsic horizon at depth \>= 50
  cm

- [`qual_endoleptic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endoleptic.md)
...
- [`qual_endothionic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endothionic.md)
  : Endothionic supplementary qualifier (etn): thionic at depth \>= 50
  cm

- [`qual_endothyric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_endothyric.md)
  : Endothyric supplementary qualifier (etc): thyric only at depth \>=
  50

- [`qual_entic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_entic.md)
  : Entic qualifier (et): albic horizon AND NOT spodic

- [`qual_epic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_epic.md)
  : Epic supplementary qualifier (ep): generic "in shallow horizon"

- [`qual_epidystric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_epidystric.md)
  : Epidystric supplementary qualifier (epd): dystric only in the upper
  part

- [`qual_epieutric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_epieutric.md)
  : Epieutric supplementary qualifier (eee): eutric only in the upper
  part

- [`qual_escalic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_escalic.md)
...
- [`qual_evapocrustic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_evapocrustic.md)
...
- [`qual_ferritic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_ferritic.md)
...
- [`qual_gelic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_gelic.md)
  : Gelic supplementary qualifier (gl): permafrost or strong frost
  activity WRB 2022 Ch 5: "Permafrost within 200 cm of the soil surface
  OR gelic materials." Modifier of cryic_conditions for non-Cryosols.

- [`qual_gelistagnic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_gelistagnic.md)
  : Gelistagnic supplementary qualifier (gst): stagnic in cold
  conditions WRB 2022 Ch 5: "Stagnic features (perched water) in cryic
  regime." Compose: stagnic_pattern + cryic_conditions.

- [`qual_geoabruptic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_geoabruptic.md)
  : Geoabruptic supplementary qualifier (ga): abrupt change at
  lithological boundary WRB 2022 Ch 5: "Abrupt textural / mineralogical
  change at a lithological discontinuity (e.g., 2C horizon below B)."
  Implementation: designation pattern containing "2C" or "3C" (numeric
  prefix indicates lithologic discontinuity).
...
- [`qual_gibbsic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_gibbsic.md)
  : Gibbsic qualifier (gi): high gibbsite (\>= 25%) in fine earth

- [`qual_gilgaic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_gilgaic.md)
  : Gilgaic supplementary qualifier (gi): gilgai microrelief WRB 2022 Ch
  5: "Gilgai microrelief (associated with vertic shrinking/swelling
  soils)." Site-level field detection.
...
- [`qual_greyzemic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_greyzemic.md)
  : Greyzemic qualifier (gz): mollic / umbric overlain by albic-like
  layer
...
- [`qual_hydrophobic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_hydrophobic.md)
...
- [`qual_hypernatric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_hypernatric.md)
  : Hypernatric supplementary qualifier (hyna): very high Na (\>= 70%
  ESP)

- [`qual_hyperorganic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_hyperorganic.md)
  : Hyperorganic supplementary qualifier (hyo): SOC \>= 18% (peat-like)
  WRB 2022 Ch 5: "Containing organic carbon \>= 18% by mass in any layer
  \>= 10 cm thick." A stronger version of \`Carbonic\`.
...
- [`qual_immissic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_immissic.md)
  : Immissic supplementary qualifier (im): atmospheric immission

- [`qual_inclinic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_inclinic.md)
...
- [`qual_isolatic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_isolatic.md)
  : Isolatic qualifier (il): isolated technic material

- [`qual_isopteric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_isopteric.md)
  : Isopteric supplementary qualifier (ip): termite / ant biogenesis

- [`qual_kalaic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_kalaic.md)
...
- [`qual_lapiadic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_lapiadic.md)
  : Lapiadic supplementary qualifier (lp): karren / lapies bedrock
  features

- [`qual_laxic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_laxic.md)
  : Laxic supplementary qualifier (lx): loose / non-cohesive surface WRB
  2022 Ch 5: "Surface horizon with loose dry consistence and
...
- [`qual_lignic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_lignic.md)
  :
  ...
  volume or weight) in organic material." Implementation:
  `woody_fragments_pct` or layer_origin matching wood.
...
- [`qual_litholinic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_litholinic.md)
...
- [`qual_mahic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_mahic.md)
  : Mahic supplementary qualifier (mh): manure-derived dark surface WRB
  2022 Ch 5: "Topsoil enriched by long-term manure / compost
  application; oc_pct \>= 4%, base_saturation_pct \>= 50%, and p_mehlich
  \>= 100 mg/kg."

- [`qual_mawic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_mawic.md)
...
- [`qual_mineralic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_mineralic.md)
  : Mineralic supplementary qualifier (mn): predominantly mineral WRB
  2022 Ch 5: "Predominantly mineral material in upper 100 cm (oc_pct \<
  12% averaged over depth)."

- [`qual_mochipic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_mochipic.md)
...
- [`qual_murshic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_murshic.md)
  : Murshic qualifier (mr): partly drained organic with strong
  decomposition

- [`qual_muusic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_muusic.md)
  : Muusic qualifier (mu): high-fibre peat (non-moss-specific)

- [`qual_naramic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_naramic.md)
...
- [`qual_nechic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_nechic.md)
  : Nechic supplementary qualifier (ne): aeolian / loess deposit pattern

- [`qual_neobrunic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_neobrunic.md)
  : Neobrunic qualifier (nb): "young" cambic-like horizon

- [`qual_neocambic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_neocambic.md)
  : Neocambic qualifier (nc): "young" cambic horizon with weak
  development

- [`qual_nitic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_nitic.md)
  : Nitic qualifier (ni): nitic horizon \<= 100 cm.

- [`qual_nudiargic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_nudiargic.md)
...
- [`qual_nudinatric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_nudinatric.md)
...
- [`qual_orthofluvic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_orthofluvic.md)
...
- [`qual_oxyaquic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_oxyaquic.md)
  : Oxyaquic qualifier (oa): saturation regime without reduction

- [`qual_oxygleyic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_oxygleyic.md)
...
- [`qual_panpaic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_panpaic.md)
  : Panpaic qualifier (pp): a panpan (cemented/indurated pan) \<= 100
  cm.

- [`qual_pantofluvic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_pantofluvic.md)
...
- [`qual_pelocrustic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_pelocrustic.md)
...
- [`qual_petrosalic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_petrosalic.md)
...
- [`qual_profundihumic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_profundihumic.md)
...
- [`qual_protoandic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_protoandic.md)
  : Protoandic supplementary qualifier (pan): early-stage andic WRB 2022
  Ch 5: "Andic-like properties below the strict threshold (oxalate Al+Fe
  0.4-2.0%)."

- [`qual_protoargic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_protoargic.md)
  : Protoargic supplementary qualifier (pra): early-stage argic WRB 2022
  Ch 5: "Clay increase 2-6 percentage points (below the canonical argic
  threshold)."
...
- [`qual_protospodic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_protospodic.md)
  : Protospodic supplementary qualifier (psp): early-stage spodic WRB
  2022 Ch 5: "Spodic-like horizon meeting weakened criteria (Al+Fe
  oxalate \< 0.5% but pyrophosphate \> 0.05%)." Lacking pyrophosphate
  field; we proxy via spodic candidate horizons that fail strict spodic.
...
- [`qual_puffic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_puffic.md)
  : Puffic supplementary qualifier (pf): puffed surface

- [`qual_pyric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_pyric.md)
  :

  Pyric supplementary qualifier (py): fire-affected horizon WRB 2022 Ch
  5: "Containing layers with charcoal / soot / fire-baked material
  (visual or chemical evidence)." Implementation: `layer_origin` or
  designation matching fire-related text.

- [`qual_raptic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_raptic.md)
  : Raptic supplementary qualifier (rp): stratification break

- [`qual_reductaquic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_reductaquic.md)
...
- [`qual_reductigleyic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_reductigleyic.md)
  : Reductigleyic qualifier (rg): gleyic + reductive

- [`qual_relocatic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_relocatic.md)
...
- [`qual_rockic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_rockic.md)
...
- [`qual_saprolithic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_saprolithic.md)
  : Saprolithic supplementary qualifier (sp): saprolite parent material

- [`qual_sideralic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_sideralic.md)
...
- [`qual_someric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_someric.md)
...
- [`qual_sulfatic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_sulfatic.md)
  : Sulfatic supplementary qualifier (su): high sulfate content WRB 2022
  Ch 5: "Containing \>= 25% gypsum or \>= 5% sulfate by mass."
...
- [`qual_thixotropic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_thixotropic.md)
  : Thixotropic supplementary qualifier (tx): thixotropic behavior

- [`qual_thyric()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_thyric.md)
...
- [`qual_tonguic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_tonguic.md)
...
- [`qual_uterquic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_uterquic.md)
...
- [`qual_wapnic()`](https://hugomachadorodrigues.github.io/soilKey/reference/qual_wapnic.md)
...
- [`test_caco3_enrichment()`](https://hugomachadorodrigues.github.io/soilKey/reference/test_caco3_enrichment.md)
...
- [`test_cambic_soil_formation()`](https://hugomachadorodrigues.github.io/soilKey/reference/test_cambic_soil_formation.md)
  : Test cambic-horizon criterion 3 (evidence of soil formation), WRB
  2022 Ch 3.1.5.
