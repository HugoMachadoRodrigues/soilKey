...
- **Cobertura de Ch 3.1 (horizontes diagnósticos):** ~30 dos ~32 horizontes implementados (incluindo todas as variantes petric, anthropogenic family, vertic_horizon, thionic, fragic, sombric, chernic). Ainda faltam: tsitelic, panpaic, limonic, protovertic — niche horizons usados por poucas RSGs e principalmente em qualifiers.
...
- **Cobertura de Ch 3.3 (materiais):** **18 de 19 materiais implementados**: aeolic, artefacts, calcaric, claric, dolomitic, fluvic, gypsiric, hypersulfidic, hyposulfidic, limnic, mineral, mulmic, organic, organotechnic, ornithogenic, soil_organic_carbon, solimovic, technic_hard, tephric. Falta apenas tephric_hard (não-distinguido na taxa atual). Histic_horizon (Ch 3.1) também serve como gate para organic_material.
