...
[`oxic_usda()`](https://hugomachadorodrigues.github.io/soilKey/reference/oxic_usda.md)
and `argillic_usda()` as delegations to WRB ferralic / argic in v0.2
(the central criteria coincide; edge differences scheduled for v0.8).
