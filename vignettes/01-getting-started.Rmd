...
This vignette walks through the **v0.6 deliverable** (post-v0.3.2 reorder): building a `PedonRecord`, calling the 26 implemented WRB 2022 diagnostics directly, classifying any of the 31 canonical fixtures end-to-end through the fully-wired WRB key (32/32 RSGs in canonical key order, pp 95-126 of WRB 2022), and watching the evidence grade respond to provenance. Sections 10-12 demonstrate the three side modules:
...
| v0.3.3   | Tier-2 gate strengthening: Ferralsol argic-exclusion, Vertisol shrink-swell cracks, Chernozem/Kastanozem protocalcic |
